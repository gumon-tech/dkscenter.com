  ...
  return (
    <div className="text-left">
      ...
      <div className="mb-6">
        ...
        <p>
          <b>การโอนข้อมูลส่วนบุคคลไปต่างประเทศ</b>
        </p>
        <p>
          เราอาจเปิดเผยหรือโอนข้อมูลส่วนบุคคลของคุณไปยังบุคคล องค์กร
          หรือเซิร์ฟเวอร์ (Server) ที่ตั้งอยู่ในต่างประเทศ
          โดยเราจะดำเนินการตามมาตรการต่าง ๆ
      ...
      <div className="mb-6">
        ...
        <p>
          นโยบายนี้แก้ไขล่าสุดและมีผลใช้บังคับตั้งแต่วันที่ 18 กุมภาพันธ์ 2567
        </p>
      </div>
      <div className="mb-6">
        <h2 className="text-3xl mb-2 text-blue-700 dark:text-blue-400">
      ...
      <div className="mb-6">
        ...
        <p>บริษัท กุมอน เทคโนโลยี จำกัด</p>

        <p>
          ชั้น 35 เลขที่ 33/4 อาคารเดอะไนน์ทาวเวอร์ ตึกเอ ถนนพระราม 9, ห้วยขวาง,
          กรุงเทพฯ, 10310
        </p>

        <p>อีเมล contact@gumon.io</p>
        <p>เว็บไซต์ www.gumon.io</p>
        <p>
          หมายเลขโทรศัพท์ <span itemprop="telephone">080-642-5659</span>
        </p>
